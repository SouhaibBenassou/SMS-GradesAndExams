...
namespace Api.Controllers
{
    ...
    public class SupervisorController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateSupervisor([FromBody] UpdateSupervisorDTO updateSupervisorDto)
        {
            var command = new UpdateSupervisorCommand(updateSupervisorDto);
